...
SKILL_CONFIG = {
    ...
    # ============================================================
    # 引用规则（注入 generate prompt）
    # ============================================================
    "citation": {
        "rule": "回答中涉及的关键结论需标注信息来源",
        "format": "【来源：{source_file} - {header}】",
        "placement": "在相关段落末尾标注",
        "no_source": "如果内容来自多个 chunk 的综合，标注主要来源即可",
    },
